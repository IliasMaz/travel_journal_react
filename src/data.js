export default [
  {
    id: 1,
    img: {
      src: "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1b/35/49/ff/mt-olympus.jpg?w=700&h=400&s=1",
      alt: "Olympos",
    },
    country: "Greece - Makedonia",
    mapsLink:
      "https://www.google.com/maps/search/Drive%20to%20Mount%20Olympus,%20Mount%20Olympus,%20Greece",
    name: "Olympos",
    date: "March-October",
    description:
      "At Macedonia In Greek mythology, Olympus is the home of the Greek gods, on Mytikas peak. The mountain has exceptional biodiversity and rich flora.",
  },
  {
    id: 2,
    img: {
    ...
    description:
      "The island is picturesque, unspoilt and blessed with more than 60 beautifully crystal clear waters and beaches. The most famous is Koukounaries, which is considered as the third most beautiful beach in the Mediterranean.",
  },
  {
    id: 3,
    img: {
